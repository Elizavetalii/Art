-- Скрипт структуры базы данных Art Culinary CRM (SQLite)
-- Сгенерировано автоматически из текущей БД db.sqlite3
...
CREATE TABLE "django_admin_log" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "object_id" text NULL, "object_repr" varchar(200) NOT NULL, "action_flag" smallint unsigned NOT NULL CHECK ("action_flag" >= 0), "change_message" text NOT NULL, "content_type_id" integer NULL REFERENCES "django_content_type" ("id") DEFERRABLE INITIALLY DEFERRED, "user_id" bigint NOT NULL REFERENCES "crm_user" ("id") DEFERRABLE INITIALLY DEFERRED, "action_time" datetime NOT NULL);
